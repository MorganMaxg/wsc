...
create table TB_ORDER (
  ...
  COMMENT '订单金额,单位:分',
  PAY_TYPE      INT(5)       NOT NULL DEFAULT 0
  COMMENT '支付类型,1.在线支付,2.货到付款',
  POST_FEE      BIGINT       NOT NULL DEFAULT 0
  COMMENT '邮费.单位:分',
  STATUS        INT(5)       NOT NULL DEFAULT 0
  COMMENT '订单状态:1.未付款,2.已付款,3.未发货,4.已付款,5.交易成功,6.交易关闭',
  ...
  COMMENT '商户ID',
  BUYER_MESSAGE VARCHAR(100) NOT NULL DEFAULT ''
  COMMENT '买家留言',
  BUYER_NICK    VARCHAR(50)  NOT NULL DEFAULT ''
  COMMENT '买家昵称',
  BUYER_RATE    BOOLEAN      NOT NULL DEFAULT FALSE
  COMMENT '买家是否已经评价'
)